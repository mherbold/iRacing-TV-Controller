	...
	public static class Settings
	{
		...
		public static void FixSettings( SettingsOverlay settings )
		{
			...
			var defaultImageSettings = new Dictionary<string, SettingsImage>() {
				...
				{ "PitLaneCarCurrentTarget", new SettingsImage() { imageType = SettingsImage.ImageType.ImageFile, filePath = Program.documentsFolder + "Assets\\default\\track-map-target.png", size = { x = 32, y = 32 }, position = { x = -1, y = 0 }, tintColor = { r = 57f / 255, g = 181f / 255, b = 74f / 255, a = 1 } } },
				...
				{ "TrackMapCarCurrentTarget", new SettingsImage() { imageType = SettingsImage.ImageType.ImageFile, filePath = Program.documentsFolder + "Assets\\default\\track-map-target.png", size = { x = 32, y = 32 }, position = { x = -1, y = 0 }, tintColor = { r = 57f / 255, g = 181f / 255, b = 74f / 255, a = 1 } } },
