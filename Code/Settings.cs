	...
	public static class Settings
	{
		...
		public static void FixSettings( SettingsOverlay settings )
		{
			...
			var defaultImageSettings = new Dictionary<string, SettingsImage>() {
				...
				{ "LeaderboardLayer1", new SettingsImage() { imageType = SettingsImage.ImageType.ImageFile, filePath = Program.documentsFolder + "Assets\\default\\leaderboard-heading.png", useClassColors = true } },
