	...
	public static class Settings
	{
		...
		public static void FixSettings( SettingsOverlay settings )
		{
			...
			var defaultImageSettings = new Dictionary<string, SettingsImage>() {
				...
				{ "BattleChyronLayer4", new SettingsImage() { imageType = SettingsImage.ImageType.ImageFile, filePath = Program.documentsFolder + "Assets\\default\\battle.png", position = { x = 452, y = 9 }, size = { x = 160, y = 160 } } },
				{ "BattleChyronLayer5", new SettingsImage() { imageType = SettingsImage.ImageType.None } },
			...
			{
				{ "BattleChyronTextLayer1", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 83, position = { x = 53, y = 6 }, alignment = TextAlignmentOptions.Top, content = SettingsText.Content.Driver_Position } },
				...
				{ "ChyronTextLayer1", new SettingsText() { fontIndex = SettingsText.FontIndex.FontA, fontSize = 83, position = { x = 53, y = 6 }, alignment = TextAlignmentOptions.Top, content = SettingsText.Content.Driver_Position } },
